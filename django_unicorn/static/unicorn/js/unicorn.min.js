...
var Unicorn = (function (e) {
  ...
  function a(e, t, i) {
    ...
    return (
      ...
      function () {
        ...
        var l = r,
          u = function () {
            (n = null), i || e.apply(l, a);
          },
          c = i && !n;
        clearTimeout(n), (n = setTimeout(u, t)), c && e.apply(l, a);
      }
    );
  }
  function s(e) {
  ...
  var d = {
    ...
    f = {
      acceptNode: function (e) {
        return e.getAttribute("unicorn:checksum")
  ...
  function m(e, t) {
    for (
      var i =
        ...
        n = document.createTreeWalker(e, NodeFilter.SHOW_ELEMENT, i, !1);
      n.nextNode();
        ...
        n(e, [
          {
            ...
            value: function () {
              var e = this;
              if (
                this.name.startsWith("unicorn:") ||
                this.name.startsWith("u:")
              ) {
                if (((this.isUnicorn = !0), c(this.name, ":model")))
                  this.isModel = !0;
                else if (c(this.name, ":poll.disable")) this.isPollDisable = !0;
                else if (c(this.name, ":poll")) this.isPoll = !0;
                else if (c(this.name, ":loading")) this.isLoading = !0;
                else if (c(this.name, ":target")) this.isTarget = !0;
                else if (c(this.name, ":partial")) this.isPartial = !0;
                else if (c(this.name, ":dirty")) this.isDirty = !0;
                else if (c(this.name, ":visible")) this.isVisible = !0;
                else if ("unicorn:key" === this.name || "u:key" === this.name)
                  this.isKey = !0;
                else if (c(this.name, ":error:")) this.isError = !0;
                else {
                  var t = this.name.replace("unicorn:", "").replace("u:", "");
                  "id" !== t &&
                    "name" !== t &&
                    "checksum" !== t &&
                    (this.eventType = t);
                ...
                var i = this.name;
                this.eventType && (i = this.eventType),
                  i
                    .split(".")
                    .slice(1)
                    .forEach(function (t) {
                      var i = t.split("-");
                      (e.modifiers[i[0]] = !(i.length > 1) || i[1]),
                        e.eventType &&
      ...
      return (
        n(e, [
            ...
            value: function () {
              ...
              if (
                ...
                this.el.parentElement &&
                  (this.parent = new e(this.el.parentElement)),
                (this.model = {}),
                (this.poll = {}),
                (this.loading = {}),
                (this.dirty = {}),
                ...
                for (
                  var i = function (e) {
                      var i = new p(t.el.attributes[e]);
                      if (
                        (t.attributes.push(i),
                        i.isUnicorn && (t.isUnicorn = !0),
                        i.isModel)
                      ) {
                        var n = "model";
                        (t[n].name = i.value),
                          (t[n].eventType = i.modifiers.lazy
                            ? "blur"
                            : "input"),
                          (t[n].isLazy = !!i.modifiers.lazy),
                          (t[n].isDefer = !!i.modifiers.defer),
                          (t[n].debounceTime =
                            (i.modifiers.debounce &&
                              parseInt(i.modifiers.debounce, 10)) ||
                            -1);
                      } else if (i.isPoll) {
                        (t.poll.method = i.value ? i.value : "refresh"),
                          (t.poll.timing = 2e3),
                          (t.poll.disable = !1);
                        var r = i.name.split("-").slice(1);
                        r.length > 0 &&
                          (t.poll.timing = parseInt(r[0], 10) || 2e3);
                      } else if (i.isPollDisable) t.poll.disableData = i.value;
                      else if (i.isLoading || i.isDirty) {
                        var o = "dirty";
                        i.isLoading && (o = "loading"),
                          i.modifiers.attr
                            ? (t[o].attr = i.value)
                            : i.modifiers.class && i.modifiers.remove
                            ? (t[o].removeClasses = i.value.split(" "))
                            : i.modifiers.class
                            ? (t[o].classes = i.value.split(" "))
                            : i.isLoading && i.modifiers.remove
                            ? (t.loading.hide = !0)
                            : i.isLoading && (t.loading.show = !0);
                      } else if (i.isTarget) t.target = i.value;
                      else if (i.isPartial)
                        i.modifiers.id
                          ? t.partials.push({ id: i.value })
                          : i.modifiers.key
                          ? t.partials.push({ key: i.value })
                          : t.partials.push({ target: i.value });
                      else if (i.isVisible) {
                        var a = i.modifiers.threshold || 0;
                        a > 1 && (a /= 100),
                          (t.visibility.method = i.value),
                          (t.visibility.threshold = a),
                          (t.visibility.debounceTime =
                            (i.modifiers.debounce &&
                              parseInt(i.modifiers.debounce, 10)) ||
                            0);
                      } else if (i.eventType) {
                      ...
                      if ((i.isKey && (t.key = i.value), i.isError)) {
                        var l = i.name.replace("unicorn:error:", "");
                        t.errors.push({ code: l, message: i.value });
                      }
                    },
                    n = 0;
                  n < this.el.attributes.length;
                  n++
                )
                  i(n);
            },
          ...
          },
          {
            key: "handleLoading",
            value: function (e) {
              this.handleInterfacer("loading", e);
            },
          },
          {
            key: "handleDirty",
            value: function (e) {
              this.handleInterfacer("dirty", e);
            },
          },
          {
            key: "handleInterfacer",
            value: function (e, t) {
              if (((t = t || !1), l(this[e]))) {
                var i, n, o, a;
                if (
                  (this[e].attr &&
                    (t
                      ? this.el.removeAttribute(this[e].attr)
                      : this.el.setAttribute(this[e].attr, this[e].attr)),
                  this[e].classes)
                )
                  if (t)
                    (i = this.el.classList).remove.apply(i, r(this[e].classes)),
                      0 === this.el.classList.length &&
                        this.el.removeAttribute("class");
                  else (n = this.el.classList).add.apply(n, r(this[e].classes));
                if (this[e].removeClasses)
                  if (t)
                    (o = this.el.classList).add.apply(
                      o,
                      r(this[e].removeClasses)
                    );
                  else
                    (a = this.el.classList).remove.apply(
                      a,
                      r(this[e].removeClasses)
                    );
              }
          ...
          },
          {
            key: "isSame",
            value: function (e) {
              return this.isSameEl(e.el);
            },
          },
          {
            key: "isSameEl",
            value: function (e) {
              return this.el.isSameNode(e);
            },
          },
          {
            key: "isSameId",
          ...
          },
          {
            ...
            value: function () {
              var e = this.el.value;
              if (this.el.type)
                if ("checkbox" === this.el.type.toLowerCase())
                  e = this.el.checked;
                else if ("select-multiple" === this.el.type.toLowerCase()) {
                  e = [];
                  for (var t = 0; t < this.el.selectedOptions.length; t++)
                    e.push(this.el.selectedOptions[t].value);
                }
              return e;
            },
          },
          {
            ...
            value: function (e) {
              s(this.el.type) ||
                ("radio" === this.el.type.toLowerCase()
                  ? this.el.value === e && (this.el.checked = !0)
                  : "checkbox" === this.el.type.toLowerCase()
                  ? (this.el.checked = e)
                  : ("select-one" === this.el.type.toLowerCase() &&
                      null == e) ||
                    (this.el.value = e));
            },
          },
          ...
          },
          {
            ...
            value: function () {
              ...
              this.errors.forEach(function (t) {
                e.el.removeAttribute("unicorn:error:".concat(t.code));
              }),
                (this.errors = []);
            },
          },
          {
            key: "isRoot",
            value: function () {
              return l(this.el.getAttribute("unicorn:checksum"));
            },
          },
        ]),
        e
  ...
  function y(e, t) {
    t.handleLoading(),
      e.loadingEls.forEach(function (i) {
        if (i.target)
          if (i.target.includes("*")) {
            var n =
                ((s = i.target),
                (l = s.split("*")),
                (u = ""),
                l.forEach(function (e, t) {
                  0 === t && "" === e
                    ? (u = u.concat("[a-zA-Z0-9_:.\\-]*"))
                    : t === l.length - 1
                    ? "" !== e && (u = u.concat("(".concat(e, ")")))
                    : (u = u.concat("(".concat(e, ")"), "[a-zA-Z0-9_:.\\-]*"));
                }),
                new RegExp(u)),
              o = [];
            r(e.root.getElementsByTagName("*")).forEach(function (e) {
              r(e.attributes).forEach(function (t) {
                ["id", "unicorn:key", "u:key"].includes(t.name) &&
                  t.value.match(n) &&
                  o.push(e);
              });
            }),
              o.forEach(function (e) {
                t.el.isSameNode(e) &&
                  (i.handleLoading(),
                  i.loading.hide ? i.hide() : i.loading.show && i.show());
              });
          } else {
            var a = h("#".concat(i.target), e.root);
            a ||
              e.keyEls.forEach(function (e) {
                a || e.key !== i.target || (a = e.el);
              }),
              a &&
                t.el.isSameNode(a) &&
                (i.handleLoading(),
  ...
  function g(e, t, i) {
    return (
      (t = t
        .trim()
        .slice(t.indexOf(i) + i.length)
        .trim())
        .split(".")
        .forEach(function (t) {
          if ((t = t.trim()))
            if (t.endsWith("()")) {
              var i = t.slice(0, t.length - 2);
              e = e[i]();
            } else {
              if (!l(e[t]))
                throw Error("'".concat(t, "' could not be retrieved"));
              e = e[t];
            }
        }),
  ...
  function E(e, t) {
    e.document.addEventListener(t, function (i) {
      var n = new v(i.target);
      n && !n.isUnicorn && (n = n.getUnicornParent()),
        n &&
          n.isUnicorn &&
          n.actions.length > 0 &&
          t in e.actionEvents &&
          e.actionEvents[t].forEach(function (t) {
            var r = t.action,
              o = t.element;
            if (n.isSame(o)) {
              e.walker(o.el, function (t) {
                e.modelEls
                  .filter(function (e) {
                    return e.isSameEl(t);
                  })
                  .forEach(function (t) {
                    if (l(t.model) && t.model.isLazy) {
                      var i = {
                        type: "syncInput",
                        payload: { name: t.model.name, value: t.getValue() },
                      };
                      e.actionQueue.push(i);
                    }
                  });
              }),
                r.isPrevent && i.preventDefault(),
                r.isStop && i.stopPropagation(),
                r.isDiscard && (e.actionQueue = []);
              var a = r.name;
              (function (e) {
                if (!c((e = e.trim()), "(") || !e.endsWith(")")) return [];
                e = e.slice(e.indexOf("(") + 1, e.length - 1);
                for (
                  var t = [], i = "", n = !1, r = !1, o = 0, a = 0, s = 0;
                  s < e.length;
                  s++
                ) {
                  var l = e.charAt(s);
                ...
                else if (t.startsWith("$returnValue"))
                  if (l(e.return) && l(e.return.value))
                    try {
                      var r = g(e.return.value, t, "$returnValue");
                      a = a.replace(t, r);
                    } catch (e) {
                      a = a.replace(t, "");
                    }
                ...
                (r.key &&
                  ...
                  (y(e, n), e.callMethod(a, r.debounceTime, n.partials));
            }
          });
    });
  }
  function b(e, t, i) {
    (i = i || t.model.eventType),
      t.events.push(i),
      t.el.addEventListener(i, function (n) {
        var r = !1;
        if (
          (e.data[t.model.name] !== t.getValue()
            ? ((r = !0), t.handleDirty())
            : t.handleDirty(!0),
          t.model.isLazy)
        ) {
        ...
        if (
          (e.lastTriggeringElements.some(function (e) {
            return e.isSame(t);
          }) || e.lastTriggeringElements.push(t),
          t.model.isDefer)
        ) {
          var a = -1;
          return (
            e.actionQueue.forEach(function (e, i) {
              e.payload.name === t.model.name &&
                ((e.payload.value = t.getValue()), (a = i));
            }),
            r && -1 === a && e.actionQueue.push(o),
            void (!r && a > -1 && e.actionQueue.splice(a))
          );
        }
        e.actionQueue.push(o),
          e.queueMessage(t.model.debounceTime, function (i, n, r) {
            r
              ? console.error(r)
              : ((i = i || []).some(function (e) {
                  return e.isSame(t);
                }) || i.push(t),
                e.setModelValues(i, n, !0));
          });
      });
  }
  var k = {},
    T = {};
  function w(e, t) {
    if (0 !== e.actionQueue.length && e.currentActionQueue !== e.actionQueue) {
      var i = e.actionQueue.some(function (e) {
        return "callMethod" === e.type;
      });
      (e.currentActionQueue = e.actionQueue), (e.actionQueue = []);
      var n = {
          id: e.id,
          data: e.data,
          checksum: e.checksum,
          actionQueue: e.currentActionQueue,
          epoch: Date.now(),
          hash: e.hash,
        },
        r = {
      ...
      (r[e.csrfTokenHeaderName] = (function (e) {
        var t = e.csrfTokenCookieName + "=",
          i = e.document.cookie.split(";").filter(function (e) {
            return e.trim().startsWith(t);
          });
        if (i.length > 0) return i[0].replace(t, "");
        var n = e.document.getElementsByName("csrfmiddlewaretoken");
        if (n && n.length > 0) return n[0].getAttribute("value");
        throw Error(
        ...
        fetch(e.syncUrl, {
          ...
          .then(function (t) {
            ...
            if (
              (e.loadingEls.forEach(function (e) {
                e.loading.hide ? e.show() : e.loading.show && e.hide(),
                  e.handleLoading(!0),
                  e.handleDirty(!0);
              }),
              304 === t.status)
          ...
          .then(function (n) {
            if (n && (!n.queued || !0 !== n.queued)) {
              if (n.error)
                throw (
                  ("Checksum does not match" === n.error &&
                    u(t) &&
                    t([], !0, null),
                  Error(n.error))
                );
              if (n.redirect)
                if (n.redirect.url) {
                  if (!n.redirect.refresh)
                    return void (e.window.location.href = n.redirect.url);
                  n.redirect.title &&
                    (e.window.document.title = n.redirect.title),
                    e.window.history.pushState({}, "", n.redirect.url);
                } else
                  n.redirect.hash && (e.window.location.hash = n.redirect.hash);
              e.modelEls.forEach(function (e) {
                e.init(), e.removeErrors(), e.handleDirty(!0);
              }),
              ...
              for (
                l(c) &&
                (e.poll.timer && clearInterval(e.poll.timer),
                c.timing && (e.poll.timing = c.timing),
                c.method && (e.poll.method = c.method),
                (e.poll.disable = c.disable || !1),
                e.startPolling());
                l(r) && l(r.id);

              ) {
                var d = e.getParentComponent(r.id);
                d &&
                  d.id === r.id &&
                  (l(r.data) && (d.data = r.data),
                  r.dom && e.morpher.morph(d.root, r.dom),
                  r.checksum &&
                    (d.root.setAttribute("unicorn:checksum", r.checksum),
                    d.refreshChecksum()),
                  d.refreshEventListeners(),
                  d.getChildrenComponents().forEach(function (e) {
                    e.init(), e.refreshEventListeners();
                  })),
                  (r = r.parent || {});
              }
              if (a.length > 0) {
                for (var f = 0; f < a.length; f++) {
                  var m = a[f],
                    p = null;
                  m.key
                    ? (p = h('[unicorn\\:key="'.concat(m.key, '"]'), e.root))
                    : m.id && (p = h("#".concat(m.id), e.root)),
                    !p &&
                      e.root.parentElement &&
                      (p = h(
                        '[unicorn\\:key="'.concat(m.key, '"]'),
                        e.root.parentElement
                      )),
                    p && e.morpher.morph(p, m.dom);
                }
                s &&
                  (e.root.setAttribute("unicorn:checksum", s),
                  e.refreshChecksum());
              } else e.morpher.morph(e.root, o);
              e.triggerLifecycleEvent("updated"),
                e.init(),
                e.refreshEventListeners();
              var v = !0;
              e.visibilityEls.forEach(function (t) {
                t.visibility.method === e.return.method &&
                  !1 === e.return.value &&
                  (v = !1);
              }),
                v && e.initVisibility(),
                e.modelEls.forEach(function (t) {
                  Object.keys(e.errors).forEach(function (i) {
                    if (t.model.name === i) {
                      var n = e.errors[i][0];
                      t.addError(n);
                    }
                ...
                e.callCalls(n.calls);
              var y = e.lastTriggeringElements;
              (e.lastTriggeringElements = []),
                (e.currentActionQueue = null),
                u(t) && t(y, i, null);
            }
          })
          .catch(function (i) {
    ...
    N = (function () {
      function e(i) {
        t(this, e),
          ...
          (this.name = i.name),
          (this.key = i.key),
          (this.messageUrl = i.messageUrl),
          (this.csrfTokenHeaderName = i.csrfTokenHeaderName),
          (this.csrfTokenCookieName = i.csrfTokenCookieName),
          (this.hash = i.hash),
          (this.data = i.data || {}),
          (this.syncUrl = "".concat(this.messageUrl, "/").concat(this.name)),
          (this.document = i.document || document),
          (this.walker = i.walker || m),
          (this.window = i.window || window),
          (this.morpher = i.morpher),
          (this.root = void 0),
          (this.modelEls = []),
          (this.loadingEls = []),
          (this.keyEls = []),
      ...
      return (
        n(e, [
          ...
          },
          {
            ...
            value: function () {
              var e = this,
                t = [];
              return (
                this.walker(this.root, function (i) {
                  if (!i.isSameNode(e.root)) {
                    var n = i.getAttribute("unicorn:id");
                    if (n) {
                      var r = k[n] || null;
                      r && t.push(r);
                    }
          ...
          },
          {
            ...
            value: function (e) {
              if (void 0 !== e) return k[e] || null;
              for (
                var t = this.root, i = null;
                !i && null !== t.parentElement;

              ) {
                var n = (t = t.parentElement).getAttribute("unicorn:id");
                n && (i = k[n] || null);
              }
              return i;
            },
              ...
              return (
                (e = e || []).forEach(function (e) {
                  var n,
                    o = e.fn,
                    a = t.window;
                  (e.fn.split(".").forEach(function (t, i) {
                    i < e.fn.split(".").length - 1 &&
                      ((a = a[t]), (o = o.slice(t.length + 1)));
                  }),
                  e.args)
                    ? i.push((n = a)[o].apply(n, r(e.args)))
                    : i.push(a[o]());
                }),
                i
              );
            ...
            value: function () {
              ...
              try {
                this.walker(
                  this.root,
                  function (t) {
                    if (!t.isSameNode(e.root)) {
                      var i = new v(t);
                      i.isUnicorn &&
                        (l(i.model)
                          ? (e.attachedModelEvents.some(function (e) {
                              return e.isSame(i);
                            }) ||
                              (e.attachedModelEvents.push(i),
                              b(e, i),
                              i.model.isLazy && b(e, i, "input")),
                            e.modelEls.some(function (e) {
                              return e.isSame(i);
                            }) || e.modelEls.push(i))
                          : l(i.loading) &&
                            (e.loadingEls.push(i), i.loading.show && i.hide()),
                        l(i.key) && e.keyEls.push(i),
                        l(i.visibility) && e.visibilityEls.push(i),
                        i.actions.forEach(function (t) {
                          e.actionEvents[t.eventType]
                            ? e.actionEvents[t.eventType].push({
                                action: t,
                                element: i,
                              })
                            : ((e.actionEvents[t.eventType] = [
                              ...
                              e.attachedEventTypes.some(function (e) {
                                ...
                                (e.attachedEventTypes.push(t.eventType),
                                E(e, t.eventType),
                                i.events.push(t.eventType)));
                        }));
                    }
                  },
                  f
          ...
          },
          {
            ...
            value: function (e, t, i, n) {
              var r = this,
                o = { type: "callMethod", payload: { name: e }, partials: i };
              this.actionQueue.push(o),
                this.queueMessage(t, function (e, t, i) {
                  i && u(n)
                    ? n(i)
                    : i
                    ? console.error(i)
                    : r.setModelValues(e, !0, !0);
                });
            },
          },
          {
            ...
            value: function () {
              ...
              "undefined" != typeof window &&
                ...
                this.visibilityEls.forEach(function (t) {
                  new IntersectionObserver(
                    ...
                    { threshold: [t.visibility.threshold] }
                  ).observe(t.el);
                });
            },
          },
          {
            ...
            value: function (e) {
              e
                ? console.error(e)
                : this.poll.timer && clearInterval(this.poll.timer);
            },
          },
          {
            key: "isPollEnabled",
              ...
              if (!this.poll.disable) {
                ...
                if (this.poll.disableData.startsWith("!")) {
                  if (
                    ...
                    return (
                      (this.poll.disableData = "!".concat(
                        this.poll.disableData
                      )),
                      !0
                    );
                  this.poll.disableData = "!".concat(this.poll.disableData);
                } else if (!this.data[this.poll.disableData]) return !0;
              }
              return !1;
            },
          },
          ...
          },
          {
            ...
            value: function (e) {
              ...
              e &&
                ...
                (this.poll.timer = setInterval(function () {
                  t.isPollEnabled() &&
                    t.callMethod(
                      t.poll.method,
                      0,
          ...
          },
          {
            key: "setValue",
            value: function (e) {
              s(e.model) || this.setNestedValue(e, e.model.name, this.data);
            },
          },
          {
            key: "setNestedValue",
            value: function (e, t, i) {
              for (var n = t.split("."), r = i, o = 0; o < n.length; o++) {
                var a = n[o];
                if (null == r) return;
                Object.prototype.hasOwnProperty.call(r, a) &&
                  (o === n.length - 1 ? e.setValue(r[a]) : (r = r[a]));
              }
            },
          },
          {
            ...
            value: function (e, t, i) {
              ...
              if ((e = e || []).length > 0) {
                ...
                l((r = e.slice(-1)[0])) &&
                  l(r.model) &&
                  !r.model.isLazy &&
                  ["id", "key"].forEach(function (e) {
                    n.modelEls.forEach(function (t) {
                      o || (r[e] && r[e] === t[e] && (t.focus(), (o = !0)));
                    });
                  });
              }
              if (
                (this.modelEls.forEach(function (e) {
                  (!t && r && r.isSame(e)) || n.setValue(e);
                }),
                i)
              ) {
                var a = this.getParentComponent();
                a && a.setModelValues(e, t, i);
              }
            },
          },
          {
            key: "queueMessage",
            value: function (e, t) {
              -1 === e ? a(w, 250, !1)(this, t) : a(w, e, !1)(this, t);
            },
          },
          {
            key: "triggerLifecycleEvent",
            value: function (e) {
              var t = this;
              e in T &&
          ...
          },
          {
            key: "trigger",
            value: function (e) {
              this.modelEls.forEach(function (t) {
                if (t.key === e) {
                  var i = t.model.isLazy ? "blur" : "input";
                  t.el.dispatchEvent(new Event(i));
                }
              });
            },
          },
  ...
  var C = "undefined" == typeof document ? void 0 : document,
    L = !!C && "content" in C.createElement("template"),
    S = !!C && C.createRange && "createContextualFragment" in C.createRange();
  function P(e) {
    return (
      (e = e.trim()),
      L
        ? (function (e) {
            var t = C.createElement("template");
            return (t.innerHTML = e), t.content.childNodes[0];
          })(e)
        : S
        ? (function (e) {
            return (
              A || (A = C.createRange()).selectNode(C.body),
              A.createContextualFragment(e).childNodes[0]
            );
          })(e)
        : (function (e) {
            var t = C.createElement("body");
  ...
  var I = {
    OPTION: function (e, t) {
      ...
      if (i) {
        ...
        "OPTGROUP" === n &&
          (n = (i = i.parentNode) && i.nodeName.toUpperCase()),
          "SELECT" !== n ||
    ...
    TEXTAREA: function (e, t) {
      ...
      if (n) {
        var r = n.nodeValue;
        if (r == i || (!i && r == e.placeholder)) return;
        n.nodeValue = i;
      }
    },
    SELECT: function (e, t) {
      if (!t.hasAttribute("multiple")) {
        for (var i, n, r = -1, o = 0, a = e.firstChild; a; )
          if ("OPTGROUP" === (n = a.nodeName && a.nodeName.toUpperCase()))
            a = (i = a).firstChild;
          else {
            if ("OPTION" === n) {
            ...
            !(a = a.nextSibling) && i && ((a = i.nextSibling), (i = null));
          }
        e.selectedIndex = r;
      }
    },
      ...
      return function (t, i, n) {
        if ((n || (n = {}), "string" == typeof i))
          if (
            ...
            var r = i;
            (i = C.createElement("html")).innerHTML = r;
          } else i = P(i);
        var o = n.getNodeKey || U,
          a = n.onBeforeNodeAdded || V,
          s = n.onNodeAdded || V,
          l = n.onBeforeElUpdated || V,
          u = n.onElUpdated || V,
          c = n.onBeforeNodeDiscarded || V,
          h = n.onNodeDiscarded || V,
          d = n.onBeforeElChildrenUpdated || V,
          f = !0 === n.childrenOnly,
        ...
        function y(e, t) {
          if (1 === e.nodeType)
            for (var i = e.firstChild; i; ) {
              var n = void 0;
              t && (n = o(i)) ? v(n) : (h(i), i.firstChild && y(i, t)),
                (i = i.nextSibling);
            }
        }
        function g(e, t, i) {
          !1 !== c(e) && (t && t.removeChild(e), h(e), y(e, i));
        }
        function E(e) {
          s(e);
          for (var t = e.firstChild; t; ) {
            ...
            if (n) {
              var r = m[n];
              r && O(t, r) ? (t.parentNode.replaceChild(r, t), b(r, t)) : E(t);
            } else E(t);
            t = i;
          }
        }
        function b(t, i, n) {
          ...
          if ((r && delete m[r], !n)) {
            if (!1 === l(t, i)) return;
            if (t.hasAttribute("u:ignore") || t.hasAttribute("unicorn:ignore"))
              return;
            if ((e(t, i), u(t), !1 === d(t, i))) return;
          }
          "TEXTAREA" !== t.nodeName
            ? (function (e, t) {
                var i,
                  ...
                  c = e.firstChild;
                e: for (; u; ) {
                  for (s = u.nextSibling, i = o(u); c; ) {
                    if (
                      ((r = c.nextSibling), u.isSameNode && u.isSameNode(c))
                    ) {
                      (u = s), (c = r);
                      continue e;
                    }
                  ...
                  if (i && (l = m[i]) && O(l, u)) e.appendChild(l), b(l, u);
                  else {
                    var f = a(u);
                    !1 !== f &&
                      (f && (u = f),
                      u.actualize && (u = u.actualize(e.ownerDocument || C)),
                      e.appendChild(u),
                      E(u));
                  }
                  (u = s), (c = r);
                ...
                !(function (e, t, i) {
                  for (; t; ) {
                    var n = t.nextSibling;
                    (i = o(t)) ? v(i) : g(t, e, !0), (t = n);
                  }
                })(e, c, n);
                var p = I[e.nodeName];
                p && p(e, t);
              })(t, i)
            : t.innerHTML != i.innerHTML && I.TEXTAREA(t, i);
        }
        !(function e(t) {
        ...
        if (!f)
          if (1 === A)
            1 === N
              ? O(t, i) ||
                ...
                (w = (function (e, t) {
                  ...
                  t,
                  ((k = i.nodeName),
                  (T = i.namespaceURI) && "http://www.w3.org/1999/xhtml" !== T
                    ? C.createElementNS(T, k)
                    : C.createElement(k))
                )))
              : (w = i);
          else if (3 === A || 8 === A) {
            if (N === A)
              return (
                w.nodeValue !== i.nodeValue && (w.nodeValue = i.nodeValue), w
              );
            w = i;
          }
        if (w === i) h(t);
        else {
          if (i.isSameNode && i.isSameNode(w)) return;
          if ((b(w, i, f), p))
            for (var L = 0, S = p.length; L < S; L++) {
              var M = m[p[L]];
              M && g(M, M.parentNode, !1);
            }
        }
        return (
          !f &&
            w !== t &&
            t.parentNode &&
            (w.actualize && (w = w.actualize(t.ownerDocument || C)),
      ...
      if (11 !== t.nodeType && 11 !== e.nodeType) {
        for (var s = a.length - 1; s >= 0; s--)
          (n = (i = a[s]).name),
            ...
            r
              ? ((n = i.localName || n),
                e.getAttributeNS(r, n) !== o &&
                  ("xmlns" === i.prefix && (n = i.name),
                  e.setAttributeNS(r, n, o)))
              : e.getAttribute(n) !== o && e.setAttribute(n, o);
        for (var l = e.attributes, u = l.length - 1; u >= 0; u--)
          (n = (i = l[u]).name),
            (r = i.namespaceURI)
              ? ((n = i.localName || n),
          ...
          n(e, [
            {
              key: "morph",
              value: function (e, t) {
                return D(e, t, this.getOptions());
              },
            },
            {
              key: "getOptions",
              value: function () {
                var e = this.options.RELOAD_SCRIPT_ELEMENTS || !1;
                return {
                  childrenOnly: !1,
                  getNodeKey: function (e) {
                    if (e.attributes) {
                      var t =
                        e.getAttribute("unicorn:id") ||
                        e.getAttribute("unicorn:key") ||
                        e.id;
                      if (t) return t;
                    }
                  },
                  onBeforeElUpdated: function (t, i) {
                    if (t.isEqualNode(i)) return !1;
                    if (
                      e &&
                      "SCRIPT" === t.nodeName &&
                      "SCRIPT" === i.nodeName
                      ...
                      return (
                        r(i.attributes).forEach(function (e) {
          ...
          n(e, [
            {
              ...
              value: function (e, t) {
                if (t) {
                  ...
                  return window.Alpine.morph(e, t, this.getOptions());
                }
              },
            },
            {
  ...
  function z(e) {
    ...
    if (
      ...
      throw Error("No component found for: ".concat(e));
    return t;
  }
  return (
    (e.addEventListener = function (e, t) {
      e in T || (T[e] = []), T[e].push(t);
    }),
    (e.call = function (e, t) {
      for (
        var i = z(e),
      ...
      o.forEach(function (e) {
        ...
        n && ((n = n.slice(0, -2)), (t = "".concat(t, "(").concat(n, ")"))),
        i.callMethod(t, 0, null, function (e) {
          console.error(e);
        });
    }),
    (e.componentInit = function (e) {
      (e.messageUrl = Q),
        (e.csrfTokenHeaderName = j),
        (e.csrfTokenCookieName = H),
        (e.morpher = x);
      var t = new N(e);
      (k[t.id] = t), t.setModelValues();
    }),
    (e.getComponent = z),
    (e.getReturnValue = function (e) {
      return z(e).return.value;
    }),
    (e.init = function (e, t, i, n) {
      return (
        ...
        (x = (function (e) {
          var t = e.NAME;
          if (s(t)) throw Error(" Missing morpher name");
          var i = R[t];
          if (i) return new i(e);
          throw Error("Unknown morpher: ".concat(t));
        })(n)),
        l(t) && (j = t),
        l(i) && (H = i),
        {
          messageUrl: Q,
          csrfTokenHeaderName: j,
          csrfTokenCookieName: H,
          morpher: x,
        }
      );
    }),
